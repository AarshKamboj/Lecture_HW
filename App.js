    ...
    >
      <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
        ...
        <div>
          ...
          <div style={{ fontSize: "12px", color: "#a78bfa", marginTop: "2px", fontWeight: 500, letterSpacing: "0.05em", textTransform: "uppercase" }}>
            {product.category}
          </div>
        </div>
      </div>
  ...
  return (
    <>
      ...
      <div style={{
        ...
        padding: "40px 24px",
        backgroundImage: "radial-gradient(ellipse 80% 50% at 50% -20%, rgba(120,40,200,0.25), transparent)",
      }}>
        <div style={{ maxWidth: "600px", margin: "0 auto" }}>

          {/* Header */}
          <div style={{ marginBottom: "36px", textAlign: "center" }}>
            <div style={{ fontSize: "11px", letterSpacing: "0.3em", color: "#7c3aed", fontWeight: 600, textTransform: "uppercase", marginBottom: "10px" }}>
              Product Explorer
            </div>
            <h1 style={{ fontFamily: "'Syne', sans-serif", fontSize: "clamp(28px, 5vw, 40px)", fontWeight: 800, lineHeight: 1.1, letterSpacing: "-0.02em" }}>
              Find What You{" "}
            ...
            {categories.map(cat => (
              <button
                ...
                style={{
                  ...
                  border: activeCategory === cat ? "1px solid #7c3aed" : "1px solid rgba(255,255,255,0.12)",
                  background: activeCategory === cat ? "linear-gradient(135deg, #7c3aed, #4f46e5)" : "rgba(255,255,255,0.04)",
          ...
          {/* Results count */}
          <div style={{ fontSize: "12px", color: "rgba(167,139,250,0.6)", marginBottom: "14px", fontWeight: 500, letterSpacing: "0.05em", textTransform: "uppercase" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
            {filtered.length > 0 ? (
              ...
              <div style={{
                ...
                color: "rgba(167,139,250,0.5)", fontSize: "15px",
              }}>
                <div style={{ fontSize: "40px", marginBottom: "12px" }}>🔍</div>
                <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: "18px", marginBottom: "6px", color: "#fff" }}>
                  No products found
                </div>
